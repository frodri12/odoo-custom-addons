...
class AccountMove(models.Model):
    ...
    def _inverse_l10n_latam_document_number(self):
        ...
        for rec in to_review:
            ...
            if current_pos != rec.journal_id.l10n_py_dnit_expedition_point or current_exp != self.company_id.l10n_py_dnit_organization:
                ...
                if (not invoices):
                    rec.journal_id.l10n_py_dnit_expedition_point = current_pos
    ...
    def _get_formatted_sequence(self, number=0):
        return "%s %03d-%03d-%07d" % (self.l10n_latam_document_type_id.doc_code_prefix,
                                 self.company_id.l10n_py_dnit_organization,
                                 self.journal_id.l10n_py_dnit_expedition_point, number)
