...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _get_demo_data(self, company:Company):
        ...
        if company in (
            self.env.ref('base.demo_company_py', raise_if_not_found=False),
        ):
        ...
        if company.account_fiscal_country_id.code == "PY":
            ...
            demo_data['res.partner']['base.res_partner_2']['l10n_py_dnit_responsibility_type_id'] = 'l10n_py_account.res_IVARI'
            demo_data['res.partner'].setdefault('base.res_partner_12', {})
            demo_data['res.partner']['base.res_partner_12']['l10n_py_dnit_responsibility_type_id'] = 'l10n_py_account.res_IVARI'
        return demo_data
